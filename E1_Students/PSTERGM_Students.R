...
d <- read.csv(file.choose(), sep = ' ', header = F)    # High-School_data_2013.csv
...
name <- c("Aug: edge sum", "Aug: dispersion", "Aug: homophily", "Aug: heterophily", "Aug: facebook", "Aug: transitivity",
          "Dim: edge sum", "Dim: dispersion", "Dim: homophily", "Dim: heterophily", "Dim: facebook", "Dim: transitivity")
